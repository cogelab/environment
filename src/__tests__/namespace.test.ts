...
const equalsNamespace = function (ns: any, expected: any) {
  fields.forEach(field => expect(ns[field]).toBe(expected[field]));
  return true;
};
    ...
    it('returns namespace', () => {
      ...
      assert(
        equalsNamespace(parsed, {
          complete: 'foo-bar',
          generatorHint: 'gen-foo-bar',
          versionedHint: 'gen-foo-bar',
          namespace: 'foo-bar',
          unscoped: 'foo-bar',
          id: 'foo-bar',
    ...
    it('returns namespace with scope', () => {
      ...
      assert(
        equalsNamespace(parsed, {
          ...
          scope: '@scope',
          unscoped: 'foo-bar',
          generatorHint: '@scope/gen-foo-bar',
          versionedHint: '@scope/gen-foo-bar',
    ...
    it('returns with semver', () => {
      ...
      assert(
        equalsNamespace(parsed, {
          complete,
          generatorHint: 'gen-foo-bar',
          versionedHint: 'gen-foo-bar@"1.0.0-beta+exp.sha.5114f85"',
          namespace: 'foo-bar',
          unscoped: 'foo-bar',
          id: 'foo-bar',
          packageNamespace: 'foo-bar',
    ...
    it('returns with semver ^', () => {
      ...
      assert(
        equalsNamespace(parsed, {
          complete,
          generatorHint: 'gen-foo-bar',
          versionedHint: 'gen-foo-bar@"^1.0.4"',
          namespace: 'foo-bar',
          unscoped: 'foo-bar',
          id: 'foo-bar',
          packageNamespace: 'foo-bar',
    ...
    it('semver space', () => {
      ...
      assert(
        equalsNamespace(parsed, {
          complete,
          generatorHint: 'gen-foo-bar',
          versionedHint: 'gen-foo-bar@"1.0.0 - 1.2.0"',
          namespace: 'foo-bar',
          unscoped: 'foo-bar',
          id: 'foo-bar',
          packageNamespace: 'foo-bar',
    ...
    it('returns with semver <=>', () => {
      ...
      assert(
        equalsNamespace(parsed, {
          complete,
          generatorHint: 'gen-foo-bar',
          versionedHint: 'gen-foo-bar@">=1.2.3 <2.0.0"',
          namespace: 'foo-bar',
          unscoped: 'foo-bar',
          id: 'foo-bar',
          packageNamespace: 'foo-bar',
